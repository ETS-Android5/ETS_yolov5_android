package com.example.yolov5_ets;
...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        if (startYolo) {
            ...
            //java.util.List<Mat> result = new java.util.ArrayList<>(1);
            //List<String> outBlobNames = new java.util.ArrayList<>();
            //outBlobNames.add(0, "output");

            Mat result = tinyYolo.forward();
            ...
            if (Arraylength >= 1) {
                ...
                for (int i = 0; i < ind.length; ++i) {
                    ...
                    Imgproc.putText(frame, cocoNames.get(idGuy) + " " + intConf + "%", box.tl(), Imgproc.FONT_HERSHEY_SIMPLEX, 2, new Scalar(255, 0, 0), 2);

                    Imgproc.rectangle(frame, box.tl(), box.br(), new Scalar(255, 255, 255), 2);
                }
            }
        }
